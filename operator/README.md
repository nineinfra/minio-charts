# Helm Chart for Minio Operator

This Helm Chart can be used to install Custom Resource Definitions and the Operator for Minio Operator provided by Nineinfra.
...
helm install minio-operator nineinfra-charts/minio-operator
```
